	...
	return (
		<>
			...
			<Modal transparent={true} animationType='slide' visible={showQR}>
				<View
					style={{ flex: 1, bottom: 50, backgroundColor: 'rgba(0, 0, 0, 0.5)' }}
				>
					<View className='bg-white rounded-t-3xl  flex absolute bottom-0 h-96 w-full justify-center items-center'>
						<TouchableOpacity
							className='absolute top-6 left-7 justify-center items-center '
							onPress={handleShowQRCode}
						>
							<MaterialCommunityIcons name='close' size={30} />
						</TouchableOpacity>
						<Text className='absolute top-6 font-semibold text-2xl text-violeta'>
							Recibir
						</Text>
						<View className='-top-2'>
							<QRCode value='Your QR Code Data' size={120} />
						</View>
						<Text className='font-normal text-base text-zinc-500 w-52 text-center'>
							Escanear dirección para recibir el pago
						</Text>
