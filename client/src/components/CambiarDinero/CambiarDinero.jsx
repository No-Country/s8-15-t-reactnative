...
const CambiarDinero = () => {
	return (
		<>
			<View className='flex items-center relative bg-fondo '>
				<ImageBackground
				...
				<View className='flex gap-2 -top-8 justify-around items-center  w-11/12  '>
				...
				<TouchableOpacity className='bg-naranja px-4 py-2 rounded-3xl'>
					<Text className='text-white font-semibold text-md '>Convertir</Text>
				</TouchableOpacity>
			</View>

			<ScrollView style={styles.scrollView}>
				<Text className='font-black mt-20 text-violeta text-3xl'>0,40000</Text>
