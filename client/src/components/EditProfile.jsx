		...
		<Modal animationType='slide' transparent={true} visible={active}>
			<View style={styles.modalContainer}>
				<View style={styles.modalContent}>
					<Text className='font-medium text-xl m-2 top-4 justify-center '>
					...
					<View className='w-full p-4 items-center top-24'>
						...
						/>
						<TouchableOpacity
							style={{ backgroundColor: '#5448C8' }}
							onPress={handleSave}
							className='font-medium mt-10 h-10 justify-center items-center w-32 rounded-3xl'
						>
